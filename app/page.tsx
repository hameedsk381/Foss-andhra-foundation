...
import { ArrowRight, Code, BookOpen, Users, Rocket, Server, Globe, Database, Megaphone, GraduationCap } from 'lucide-react'
...
export default function Home() {
  ...
  ? Object.entries(programInfo).map(([key, value]) => ({
      id: key,
      title: value.title,
  ...
  const getIconComponent = (iconName: string) => {
    ...
    const IconComponent = icons[iconName] || Code; // Default to Code
    return <IconComponent className="h-6 w-6" />; // Render JSX outside of the lookup
  };
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="w-full py-10 md:py-14 lg:py-16 bg-primary relative overflow-hidden">
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4 mt-4">
                ...
                <Link href="/contribute">
                  <AnimatedButton variant="outline" className="border-white bg-transparent text-white">
                    Contribute
                  </AnimatedButton>
                </Link>
              </div>
