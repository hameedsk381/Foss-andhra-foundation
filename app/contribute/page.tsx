                ...
                <CardContent>
                  <form className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <select id="donationType" className="w-full p-2 border rounded-md">
                    ...
                    <div className="space-y-2">
                      ...
                      <input id="name" className="w-full p-2 border rounded-md" placeholder="Enter your full name" />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        <div className="border rounded-md p-3 text-center cursor-pointer hover:bg-gray-50">
                        ...
                        <div className="border rounded-md p-3 text-center cursor-pointer hover:bg-gray-50">
                          <p className="text-sm font-medium">NetBanking</p>
                        </div>
                      </div>
                    </div>

                    <div className="flex items-start">
                      <input type="checkbox" id="anonymous" className="mt-1 mr-2" />
