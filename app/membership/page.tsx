            ...
            {formSubmitted ? (
              <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
                ...
                <p className="text-green-700 mb-6">
                  Thank you for registering with FOSS Andhra. We've sent a confirmation email to {formData.email}.
                </p>
                <Button onClick={() => setFormSubmitted(false)}>Register Another Member</Button>
              </div>
            ) : (
              <Card>
                <CardHeader>
